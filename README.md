...
A **profile** is a named bundle that declares a tier plus optional extra
allowed domains and a default `--repo`. Numeric profiles (`--profile 1`,
`--profile 2`, `--profile 3`) are pure aliases for `--tier`. Named
profiles resolve a YAML file:
