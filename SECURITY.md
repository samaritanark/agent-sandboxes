...
**Fallback — email.** If you don't have a GitHub account or the
advisory form is unavailable, email **talvon@runlevel6.us** with:

- A description of the issue and the impact you see.
- Steps to reproduce (or a proof-of-concept).
- Affected versions, if known.

Mark the subject line URGENT if the issue is actively being exploited.
